...
echo " "
echo "NOTICE!  This is an early release feature!!! Full testing has not been completed!!"
echo " "
echo "This shell script will build a docker container that is designed to contain all "
echo "of the tooling necessary to deploy MARA."
echo " "
echo "We use asdf to manage the installed versions of the tools. These tools and versions are listed"
echo "in the tools-versions file in the directory with this Dockerfile."
echo " "
...
echo "================================================================================================="
echo " "
echo "Additionally, the python packages listed in default-python-packages file in this directory will be"
echo "installed."
echo " "
echo "Current contents are:"
echo "================================================================================================="
...
echo "================================================================================================="
echo " "
echo "Unlike the other docker builds in this directory, the container created by this script in intended to "
echo "be used with the repository this script is being run in."
echo " "
echo "The following docker run command will mount the correct directories for deployment using pulumi and aws:"
echo " "
echo "================================================================================================="
echo "docker run -it --rm -v /var/run/docker.sock:/var/run/docker.sock -v $HOME/.aws:/home/mara/.aws \ "
echo " -v $HOME/.pulumi:/home/mara/.pulumi  \ "
echo " -v $HOME/repos/kic-reference-architectures:/home/mara/kic-reference-architectures \ "
echo " mara-runner-pulumi:${IMAGETYPE}  /bin/bash"
echo "================================================================================================="
echo " "
...
docker build ${additional_docker_opts} \
  ...
  -t "mara-runner-pulumi:${IMAGETYPE}" \
  -f "${script_dir}/Dockerfile.${IMAGETYPE}" \
  "${script_dir}/.."
